...
return(
_react2.default.createElement(_reactNative.View,{style:containerStyle,__source:{fileName:_jsxFileName,lineNumber:56}},
function(){
if(_this2.props.hideHorizontalGridLines)return null;
return(
_react2.default.createElement(_reactNative.View,{style:{position:'absolute',flexDirection:'column',justifyContent:'space-around'},__source:{fileName:_jsxFileName,lineNumber:60}},
horizontalRange.map(function(_,i){return _react2.default.createElement(_reactNative.View,{key:i,style:horizontalGridStyle,__source:{fileName:_jsxFileName,lineNumber:61}});})));
...
return(
_react2.default.createElement(_reactNative.View,{style:{flexDirection:'row',position:'absolute',justifyContent:'space-around'},__source:{fileName:_jsxFileName,lineNumber:68}},
verticalRange.map(function(_,i){return _react2.default.createElement(_reactNative.View,{key:i,style:verticalGridStyle,__source:{fileName:_jsxFileName,lineNumber:69}});})));


}()));


}}]);return Grid;}(_react.Component);Grid.propTypes={showGrid:_propTypes2.default.bool,data:_propTypes2.default.array.isRequired,verticalGridStep:_propTypes2.default.number.isRequired,gridLineWidth:_propTypes2.default.number,gridColor:_propTypes2.default.oneOfType([_propTypes2.default.number,_propTypes2.default.string]),hideHorizontalGridLines:_propTypes2.default.bool,hideVerticalGridLines:_propTypes2.default.bool,height:_propTypes2.default.number.isRequired,width:_propTypes2.default.number.isRequired,type:_propTypes2.default.oneOf(['line','bar','pie']).isRequired};Grid.defaultProps={};exports.default=Grid;