...
key:index,__source:{fileName:_jsxFileName,lineNumber:55}},
...
this.props.placement==='right'&&{borderLeftColor:this.props.axisColor,borderLeftWidth:this.props.axisLineWidth}],__source:{fileName:_jsxFileName,lineNumber:74}},


range.map(this._createLabelForYAxis)));


}}]);return YAxis;}(_react.Component);YAxis.propTypes={axisColor:_propTypes2.default.any,axisLineWidth:_propTypes2.default.number,data:_propTypes2.default.arrayOf(_propTypes2.default.array).isRequired,height:_propTypes2.default.number.isRequired,placement:_propTypes2.default.oneOf(['left','right']),verticalGridStep:_propTypes2.default.number.isRequired,yAxisTransform:_propTypes2.default.func};YAxis.defaultProps={placement:'left'};exports.default=YAxis;