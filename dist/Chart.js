...
return(
_react2.default.createElement(_reactNative.View,{__source:{fileName:_jsxFileName,lineNumber:153}},
function(){
...
onLayout:_this2._onContainerLayout,__source:{fileName:_jsxFileName,lineNumber:158}},

_react2.default.createElement(_reactNative.View,{style:[styles.default,{flexDirection:'row'}],__source:{fileName:_jsxFileName,lineNumber:163}},
...
height:_this2.state.containerHeight-_this2.props.xAxisHeight,
minVerticalBound:_this2.state.bounds.min,
maxVerticalBound:_this2.state.bounds.max,__source:{fileName:_jsxFileName,lineNumber:176}}))),


function(){
return(
_react2.default.createElement(_reactNative.View,{ref:'xAxis',__source:{fileName:_jsxFileName,lineNumber:187}},
...
align:axisAlign,
style:{marginLeft:_this2.props.yAxisWidth-1},__source:{fileName:_jsxFileName,lineNumber:188}}))));
...
style:[_this2.props.style||{},styles.default],__source:{fileName:_jsxFileName,lineNumber:203}},
...
minVerticalBound:_this2.state.bounds.min,
maxVerticalBound:_this2.state.bounds.max,__source:{fileName:_jsxFileName,lineNumber:208}}))));
...
color:_propTypes2.default.oneOfType([_propTypes2.default.number,_propTypes2.default.string]),
...
dataPointColor:_propTypes2.default.oneOfType([_propTypes2.default.number,_propTypes2.default.string]),
dataPointFillColor:_propTypes2.default.oneOfType([_propTypes2.default.number,_propTypes2.default.string]),
